...
export default function QuestionListPage() {
  ...
  async function loadReviewsForQuestion(pregunta: Pregunta) {
    ...
    try {
      const res = await fetch(`${BASE_URL}/questions/${pregunta.id}/reviews`, {
        method: "GET",
  ...
  async function enviarReview() {
    ...
    try {
      const res = await fetch(`${BASE_URL}/questions/${modalPregunta.id}/reviews`, {
        method: "POST",
        headers: {
  ...
  return (
    <main style={DivMainStyle}>
          ...
          {loading ? (
            [1, 2, 3].map((i) => (
              <div
                ...
                style={{
                  display: "flex",
                  alignItems: "stretch",
                  borderBottom: "1px solid rgba(100,60,255,.1)",
                  padding: "20px",
                }}
              >
                <div
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <div
                    style={{
                      ...
                      height: 10,
                      borderRadius: 4,
                      background: "rgba(99, 60, 255, 0.95)",
                      animation: "pulse 1.5s infinite",
                    }}
                  />
                </div>
            ...
            filtered.map((p, i) => (
              <div
                key={p.id}
                className="q-row"
                onClick={() => router.push(`/question/${p.id}`)}
                style={{
                  display: "flex",
                  alignItems: "stretch",
                  borderBottom: i < filtered.length - 1 ? "1px solid rgba(100,60,255,.1)" : "none",
                  cursor: "pointer",
              ...
              >
                <div
                  style={{
                    minWidth: 56,
                    borderRight: "1px solid rgba(100,60,255,.1)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontFamily: "'Space Mono', monospace",
                ...
                >
                  <p style={{ color: "#e0d4ff", fontSize: 14, fontWeight: 700, lineHeight: 1.5 }}>
                    {p.title}
                  </p>
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    <span style={TagCategoryStyle}>{p.category}</span>
                    <span style={{ ...TagBaseStyle, ...diffStyle(p.difficulty) }}>
      ...
      <button onClick={openModal} style={{ ...FixedButtonStyle, bottom: 28, left: 28 }}>
        Añadir reseña
      </button>

      <button onClick={openReviewsModal} style={{ ...FixedButtonStyle, bottom: 28, left: 260 }}>
        Ver reseñas
      </button>
      ...
      <button
        ...
        onClick={() => router.push("/question/add")}
        ...
        <div onClick={() => setModalOpen(false)} style={ModalOverlayStyle}>
          <div onClick={(e) => e.stopPropagation()} style={ModalContentStyle}>
            <div style={ModalHeaderStyle}>
              ...
              <div onClick={() => setModalOpen(false)} style={CloseButtonStyle}>
                &#x2715;
              </div>
            </div>
              ...
              <>
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <select
                    ...
                    style={{
                      ...SelectStyle,
                      color: modalPregunta ? "#e0d4ff" : "rgba(160,130,255,.4)",
                    }}
                  >
                ...
                <button
                  ...
                  style={{
                    ...SubmitButtonStyle,
                    background:
                      !modalPregunta || !modalComment.trim()
                        ? "rgba(100,60,255,.2)"
                        : "linear-gradient(135deg,#7040ff,#5020e0)",
                    cursor: !modalPregunta || !modalComment.trim() ? "not-allowed" : "pointer",
                  }}
                >
        ...
        <div onClick={() => setReviewsModalOpen(false)} style={ModalOverlayStyle}>
          <div onClick={(e) => e.stopPropagation()} style={ModalLargeContentStyle}>
            ...
            >
              ...
              <div onClick={() => setReviewsModalOpen(false)} style={CloseButtonStyle}>
                &#x2715;
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <select
                title="Selecciona una pregunta para ver reseñas"
                ...
                style={{
                  ...SelectStyle,
                  color: selectedPreguntaForReviews ? "#e0d4ff" : "rgba(159, 130, 255, 0.78)",
                }}
              >
                <option value="" disabled>
                  Elige una pregunta...
                ...
                >
                  <span
                    style={{
                      ...
                      letterSpacing: "1px",
                      textTransform: "uppercase",
                      color: "rgba(160,130,255,.6)",
                    }}
                  >
                    Pregunta:
                  </span>
                  <span style={{ color: "#ddd0ff", fontSize: 12, fontWeight: 700 }}>
                    {selectedPreguntaForReviews.title}
                  </span>
                </div>
                    ...
                    {reviews.map((review, i) => (
                      <div
                        ...
                        style={{
                          ...
                          background: "rgba(100,60,255,.05)",
                          borderRadius: 12,
                          border: "1px solid rgba(100,60,255,.1)",
                        }}
                      >
